    ...
    public partial class Level2 : Form
    {
        ...
        public void Inicijalizacija()
        {
            for (int i = 0; i < 7; i++)
            {
                for (int j = 0; j < 9; j++)
                {
                    ...
                    if (brojSlika == 0)
                    {
                        image = Resources.jabolko;
                        brSlika = 0;

                    }
                    else if (brojSlika == 1)
                    {
                        image = Resources.jagoda;
                        brSlika = 1;
                    }
                    else if (brojSlika == 2)
                    {
                        image = Resources.krusha;
                        brSlika = 2;
                    }
                    else if (brojSlika == 3)
                    {
                        image = Resources.limon;
                        brSlika = 3;
                    }
                    else if (brojSlika == 4)
                    {
        ...
        public void MoreThan2()
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                for (int j = 0; j < 9; j++)
                {
                    ...
                    {
                        sliki[i, j].image = Resources.banana;
                    }
                    else if (sliki[i, j].brojSlika == 3)
                    {
                        sliki[i, j].image = Resources.limon;

                    }
                    else if (sliki[i, j].brojSlika == 2)
                    {
                        sliki[i, j].image = Resources.krusha;

                    }
                    else if (sliki[i, j].brojSlika == 1)
                    {
                        sliki[i, j].image = Resources.jagoda;

                    }
                    if (sliki[i, j].brojSlika == 0)
                    {
                        sliki[i, j].image = Resources.jabolko;
        ...
        public void GenerateNew()
        {
            ...
            for (int i = 0; i <= 6; i++)
            {
                for (int j = 0; j <= 8; j++)
                {
                    ...
                    if (brSlika == 0)
                    {
                        slika1 = Resources.jabolko;
                        brojSlika = 0;
                    }
                    else if (brSlika == 1)
                    {
                        slika1 = Resources.jagoda;
                        brojSlika = 1;
                    }
                    else if (brSlika == 2)
                    {
                        slika1 = Resources.krusha;
                        brojSlika = 2;
                    }
                    else if (brSlika == 3)
                    {
                        slika1 = Resources.limon;
                        brojSlika = 3;
                    }
                    else if(brSlika==4)
                    {
                        slika1 = Resources.banana;
                        brojSlika = 4;
                    }
                    if (sliki[i, j].brojSlika == 5)
                    {
        ...
        private void nextLevel()
        {
            if (brojac == 120)
            {
                ...
                timer5.Stop();
                MessageBox.Show("You have completed this level.\n Congratulations! You are now Level 3.", "Next level", MessageBoxButtons.OK);
